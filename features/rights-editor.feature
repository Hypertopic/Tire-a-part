...
Fonctionnalité: Consulter les droits de publications des éditeurs.
 ...
 Le chercheur souhaite publier son travail. Il aimerait avant cela, accèder à la liste des droits propres à chaque éditeur.

Scénario: le chercheur visualise les droits de tous les éditeurs

 Etant donné que le chercheur veut publier son travail
 Et que il souhaite obtenir des informations sur les éditeurs
 Quand il accède à la liste des éditeurs
 Alors les droits de tous les éditeurs sont affichés

Scénario: le chercheur recherche les droits propre à un éditeur

 Etant donné que le chercheur a ciblé un éditeur précis
 Et que il souhaite obtenir les droits sur cet éditeur
